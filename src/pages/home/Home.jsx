...
export default function Home() {
  let img = new ImageModel("/landing-slushies.png", "Landing view slushy showcase")
  const products = [new ProductModel("id1", "Tropical Tango Twist", "A zesty fusion of exotic fruit", new ImageModel("/slushy-1.png", "A slushy"), 2.99, true), new ProductModel("id2", "Fizzy Peach Paradise", "Peach kissed with sparkling delight", new ImageModel("/slushy-1.png", "A slushy"), 3.99, false)]
