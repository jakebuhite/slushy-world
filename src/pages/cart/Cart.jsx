...
export default function Cart() {
  const cart = useMemo(() => [new ProductModel("id1", "Tropical Tango Twist", "A zesty fusion of exotic fruit", new ImageModel("public/slushy-1.png", "A slushy"), 2.99, true), new ProductModel("id2", "Fizzy Peach Paradise", "Peach kissed with sparkling delight", new ImageModel("public/slushy-1.png", "A slushy"), 3.99, false)], [])
